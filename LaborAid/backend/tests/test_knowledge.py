...
@pytest.mark.asyncio
async def test_list_knowledge_empty(client, admin_auth_headers):
    """Listing knowledge items when none exist should return an empty list."""
    response = await client.get("/api/v1/knowledge", headers=admin_auth_headers)
...
@pytest.mark.asyncio
async def test_create_knowledge(client, admin_auth_headers):
...
@pytest.mark.asyncio
async def test_create_knowledge_empty_title(client, admin_auth_headers):
...
@pytest.mark.asyncio
async def test_knowledge_stats(client, admin_auth_headers):
    ...
    response = await client.get("/api/v1/knowledge/stats", headers=admin_auth_headers)
    assert response.status_code == 200
    data = response.json()
...
@pytest.mark.asyncio
async def test_delete_knowledge(client, admin_auth_headers):
...
@pytest.mark.asyncio
async def test_knowledge_search(client, admin_auth_headers):
