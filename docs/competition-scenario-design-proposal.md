...
├─────────────────────────────────────────────────────────────┤
│  技术层：LEAP · MICE · Graph-RAG · SADG · Supervisor Agent   │
├─────────────────────────────────────────────────────────────┤
...
7. **关键算法四 SADG + Supervisor 多 Agent**  
8. **法律工具箱矩阵**（第七节表格）  
9. **实验结果**：消融 + 对比 + 指标表  
...
| 评委可能问 | 推荐答法 |
|-----------|----------|
| 你们有没有 AI 算法？ | 有 **LEAP 路径规划、MICE 多模态质证、Graph-RAG、SADG**，面向劳动争议场景设计，不是通用聊天 |
...
2. **Named Pipeline** — LEAP / MICE / Graph-RAG / SADG 可讲、可画、可测  
