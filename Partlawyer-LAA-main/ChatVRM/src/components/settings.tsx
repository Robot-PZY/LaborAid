    ...
    <div className="absolute z-40 w-full h-full bg-white/80 backdrop-blur ">
      ...
      <div className="max-h-full overflow-auto">
        <div className="text-text1 max-w-3xl mx-auto px-24 py-64 ">
          ...
          <div className="my-24">
            ...
            <div>
              ...
              <Link
                ...
                label="OpenAI 官网"
              />
              获取。请将获取的 API 密钥输入到表单中。
            </div>
            <div className="my-16">
              ChatGPT API 是直接从浏览器访问的。此外，API 密钥和对话内容不会保存在 Pixiv 的服务器上。
              <br />
              ※使用的模型是 ChatGPT API (GPT-3.5)。
            </div>
          </div>
          <div className="my-40">
            ...
            <div className="my-8">
              <TextButton onClick={onClickOpenVrmFile}>打开 VRM 文件</TextButton>
            </div>
          </div>
          <div className="my-40">
            <div className="my-8">
          ...
          <div className="my-40">
            <div className="my-16 typography-20 font-bold">语音调整 (GPT-SoVITS 无效)</div>
            <div>
              Koemotion 的 Koeiromap API 设置（使用本地语音时可忽略）。详情请参阅
              <Link
            ...
            <div className="mt-16 font-bold">预设风格</div>
